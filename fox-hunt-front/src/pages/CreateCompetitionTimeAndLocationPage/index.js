...
const CreateCompetitionTimeAndLocationPage = (props) => {
  ...
  const addPoint = (event) => {
    ...
    const inLocationArea = polygonRef.geometry.contains(coordinates);
  ...
  const onPointDragEnd = (event) => {
    ...
    const inLocationArea = polygonRef.geometry.contains(markerCoordinates);
                      ...
                      {state.isMapShown && !isLocationLoading && (
                        <Grid item>
                          <LocationMapContainer
                            ...
                            setPolygonInstanceRef={(ref) => (polygonRef = ref)}
...
CreateCompetitionTimeAndLocationPage.defaultProps = {
  competition: {
    coachId: '',
